...
export default function CreateProfile() {
  ...
  const handleSubmit = (e) => {
    ...
    const interestMaxNum = Number(form.interestMax) / 100;
    const profile = {
      ...form,
    ...
    return (
      <div className="max-w-lg mx-auto py-20 px-6 text-center">
        ...
        <p className="text-gray-500 mb-8">
          Your buyer profile is live on HomeMatch. Sellers whose listings match your terms will be able to find you.
        </p>
    ...
    <div className="max-w-3xl mx-auto py-10 px-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 space-y-5">
          ...
          <Field label="About You" hint="Tell sellers a bit about yourself — who you are, your situation, and what you're looking for.">
            <textarea
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 space-y-5">
          ...
          <p className="text-sm text-gray-500">Used for matching — be as accurate as you can. This helps surface listings where the numbers actually work for you.</p>
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 space-y-5">
            ...
            <div className="flex flex-wrap gap-4 mt-2">
              {DEAL_OPTIONS.map(({ value, label }) => (
                <label key={value} className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="checkbox"
                    checked={form.dealPreferences.includes(value)}
                    onChange={() => toggleDeal(value)}
          ...
          <Field label="Risk Tolerance" hint="How flexible are you on deal terms, seller conditions, or property condition?">
            ...
            <div className="mt-2 text-xs text-gray-400 space-y-0.5">
              ...
              <p><strong>High</strong> — Comfortable with complex arrangements, willing to take on more uncertainty for the right deal.</p>
            </div>
          </Field>
        </div>
        ...
        <div className="flex gap-3">
          <button type="submit" className="flex-1 sm:flex-none px-8 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors">
            Create My Profile
          </button>
