...
export default function Navbar() {
  ...
  const primaryCtaClass = isBusiness
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center gap-3">
        ...
        <div className="hidden md:flex items-center gap-2 ml-auto">
          <Link to={isHomes ? "/create-profile" : "/business/create-profile"}
            className="px-3.5 py-2 text-sm font-medium border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">
